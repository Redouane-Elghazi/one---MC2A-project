...
\begin{document}
	...
	\section{Résultats}
		...
		\begin{figure}\label{ex1}
			...
			\caption{Évolution de l'énergie en fonction du temps pour divers $\alpha$ et $\beta$}
		\end{figure}
		...
		\begin{figure}\label{ex2}
			...
			\caption{Représentation de l'énergie et de chevauchement en fonction de $\alpha$ et de $\beta$}
		\end{figure}
